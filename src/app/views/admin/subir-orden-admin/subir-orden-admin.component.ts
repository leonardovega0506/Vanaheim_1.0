...
@Component({
  selector: 'app-subir-orden-admin',
  templateUrl: './subir-orden-admin.component.html',
  styleUrls: ['./subir-orden-admin.component.css']
})
export class SubirOrdenAdminComponent implements OnInit {
